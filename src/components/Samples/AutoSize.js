  ...
  render() {
    ...
    const config = {
      ...
      items: [
        ...
        { id: 4, parent: 0, isVisible: true, description: "VP, Software & Enterprise Management Division", email: "sarakemp@name.com", groupTitleColor: "#4169e1", image: photos.g, itemTitleColor: "#4b0082", phone: "918-257-4218", title: "Sara Kemp" },
        ...
        { id: 9, parent: 3, isVisible: true, description: "GM, Software Server Solutions Group", email: "abbilaws@name.com", groupTitleColor: "#4169e1", image: photos.a, itemTitleColor: "#4b0082", phone: "530-322-6413", title: "Abbie Lawson" },
        ...
        { id: 11, parent: 4, isVisible: true, description: "CFO, Platforms Products & Services", email: "celecrum@name.com", groupTitleColor: "#4169e1", image: photos.h, itemTitleColor: "#4b0082", phone: "419-578-6479", title: "Celestina Crum" },
        { id: 12, parent: 4, isVisible: true, description: "GM, Pricing", email: "cindturn@name.com", groupTitleColor: "#4169e1", image: photos.j, itemTitleColor: "#4b0082", phone: "530-934-4295", title: "Cindy Turner" }
      ]
    };
