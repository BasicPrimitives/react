...
import { Rect, getFixOfPixelAlignment, getInnerSize, Callout, CalloutAnnotationControlConfig } from 'basicprimitives';
...
import CalloutAnnotationComponentConfigShape from './Schemas/CalloutAnnotationComponentConfigShape';

class CalloutAnnotationComponent extends Component {
  static propTypes = {
    config: CalloutAnnotationComponentConfigShape.isRequired // eslint-disable-line react/no-unused-prop-types
  };
  ...
  constructor(props) {
    ...
    this.callout = new Callout(this.graphics);
    this.defaultOptions = new CalloutAnnotationControlConfig();
  }
...
export default CalloutAnnotationComponent;
